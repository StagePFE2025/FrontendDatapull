      ...
      <ComponentCard
        title={      <div className="flex flex-col items-center justify-center mb-4">
          ...
          <label className="text-center max-lg opacity-80 text-gray-800 dark:text-gray-200" style={{fontSize: "1rem"}}>
            Découvrez des e-mails professionnels cachés que personne d’autre ne peut trouver.
          </label>
        </div>} 
        ...
        >
          <div className="flex items-center">
            ...
            <Typography variant="h5" color="white" className="font-bold">
              Rechercher des emails professionnels 
            </Typography>
          </div>
        </CardHeader>
            ...
            >
              {loading ? (
                <div className="flex items-center justify-center gap-2">
                  ...
                  Recherche d’emails professionnels en cours… 
                </div>
              ) : (
                <div className="flex items-center justify-center gap-2">
          ...
          {validEmails.length > 0 ? (
            ...
            <div className="text-center py-16">
              ...
              <Label color="blue-gray" className="font-medium mb-2">
                Aucun e-mail fantôme découvert pour l’instant. 
              </Label>
              <Label color="blue-gray" className="text-sm text-blue-gray-500">
                Entrez le nom d’une personne et le domaine de l’entreprise pour commencer à rechercher les e-mails cachés. 
              </Label>
            </div>
          )}
        </CardBody>
