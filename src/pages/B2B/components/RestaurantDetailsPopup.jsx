...
const RestaurantDetails = ({
  ...
  const statusColor = restaurant.status && restaurant.status.includes("Open") ? "#34d399" : "#f87171";
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          width: "100%",
          maxWidth: "1100px", // Légère augmentation pour un look plus spacieux
          maxHeight: "120vh ",
      ...
      >
        <div
          ...
          style={{
            position: "relative",
            height: "280px", // Légère augmentation pour un visuel plus immersif
            width: "100%",
          }}
        >
          <img
            ...
            style={{
              ...
              transition: "transform 0.3s ease", // Zoom subtil sur hover
            }}
          ...
          >
            <h2
              ...
              style={{
                margin: "0 0 12px 0",
                fontSize: "32px", // Taille augmentée pour plus d'impact
                fontWeight: "700",
              ...
              >
                ...
                >
                  {restaurant.hours.map((dayInfo, index) => {
                    ...
                    const isToday = days[today] === dayInfo.day;
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          {dayInfo.times && dayInfo.times.join(", ")}
                        </span>
                      </div>
                    );
                  })}
                      ...
                      >
                        ...
                        >
                          <div
                            ...
                            style={{
                              width: `${(count / restaurant.reviews) * 100}%`,
                              height: "100%",
