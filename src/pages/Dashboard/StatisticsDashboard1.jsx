...
export default function StatisticsDashboard() {
  ...
  // Fonction pour utiliser des données d'exemple en cas d'échec de l'API
  ...
  // Rendu d'un graphique à barres pour les onglets détaillés
  ...
  // Rendu d'un graphique linéaire pour les onglets détaillés
  ...
  // Rendu d'un petit histogramme pour les éléments principaux du tableau de bord
  const renderTopItemsHistogram = (data, fillColor) => {
    return (
  ...
  // Fonction pour rendre le graphique approprié en fonction du type sélectionné
  ...
  const renderDashboard = () => {
    ...
    return (
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 col-span-1 md:col-span-2 lg:col-span-3 flex items-center">
          <div>
            ...
            <p className="text-gray-500">Utilisateurs enregistrés</p>
          </div>
          <div className="ml-auto bg-indigo-50 p-3 rounded-lg">
            <svg
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-lg font-semibold text-gray-800">Top Régions</h2>
            <div className="bg-rose-50 text-rose-700 text-xs font-medium px-2.5 py-0.5 rounded-full">
              Localisation
            </div>
          </div>
          {renderTopItemsHistogram(topRegions, "#8b5cf6")}
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="bg-emerald-50 text-emerald-700 text-xs font-medium px-2.5 py-0.5 rounded-full">
              Localisation
            </div>
          </div>
          {renderTopItemsHistogram(topDepartments, "#6366f1")}
        </div>

        {/* Top villes */}
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-lg font-semibold text-gray-800">Top Villes</h2>
            <div className="bg-amber-50 text-amber-700 text-xs font-medium px-2.5 py-0.5 rounded-full">
              Localisation
            </div>
          </div>
          {renderTopItemsHistogram(topCities, "#10b981")}
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 md:col-span-2 lg:col-span-3">
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="bg-purple-50 text-purple-700 text-xs font-medium px-2.5 py-0.5 rounded-full">
              Social
            </div>
          </div>
          <div className="w-full">
            {renderPieChart(stats.relationshipStatus)}
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 md:col-span-2 lg:col-span-3">
          ...
          <div className="w-full">{renderPieChart(stats.gender)}</div>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          ...
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              <p className="text-gray-500 text-sm">Dernière analyse</p>
...
xmlns="http://www.w3.org/2000/svg"
  ...
  if (error) {
    return (
      <div className="flex items-center justify-center h-screen bg-gray-50">
        <div className="bg-red-50 border-l-4 border-red-500 text-red-700 p-6 rounded-lg shadow-md max-w-lg">
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex mb-8 bg-white rounded-lg shadow-sm overflow-hidden border border-gray-100">
          <button
        ...
        {activeTab !== "dashboard" && (
          <div className="mb-6 p-4 bg-white rounded-lg shadow-sm border border-gray-100 flex items-center">
        ...
        {activeTab === "departments" && (
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <div className="flex justify-between items-center mb-6">
              ...
              <div className="bg-indigo-50 text-indigo-700 py-1 px-3 rounded-full text-sm font-medium flex items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
